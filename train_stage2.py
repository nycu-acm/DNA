...
def main(opt):
    ...
    if len(opt.pretrained_model) > 0:
        ...
        if len(pretrained_dict) > 0:
            ...
            model.content_encoder.requires_grad = False
            model.content_encoder_c.requires_grad = False
            model.mixer.requires_grad = False
    ...
    trainer = Trainer(model, criterion, optimizer, train_loader, logs, char_dict, test_loader, stage='2')
    trainer.train()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log', default='stage2',
